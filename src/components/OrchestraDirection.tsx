...
const OrchestraDirection = () => {
  ...
  const videoTitle = "Debut como Director Invitado — Orquesta Sinfónica Nacional de Paraguay";
  const videoDescription =
    "Debut como Director Invitado — Orquesta Sinfónica Nacional de Paraguay.";
